...
If the Worker lives somewhere other than `runway.paul-o-a04.workers.dev`, add `&api=https://…` to the link, or change the default at the top of the script in `index.html`.
...
Open `http://localhost:8080/?c=<code>&api=https://runway.paul-o-a04.workers.dev`. The Worker allows `localhost:8080` as an origin.
